                    ...
                    <div className="relative p-6 bg-white/5 backdrop-blur-xl rounded-2xl border border-white/10">
                      ...
                      <div>
                        ...
                        <p className="text-gray-500 text-xs mt-1">
                          ≈ ${(walletState.balance * CONFIG.TOKEN_SOL_VALUE).toFixed(2)} USD
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="relative p-6 bg-white/5 backdrop-blur-xl rounded-2xl border border-white/10">
                      ...
                      <div className="grid grid-cols-2 gap-4 mb-6">
                        <div className="p-4 rounded-xl bg-white/5 border border-white/5">
                          ...
                          <p className="text-gray-500 text-xs mt-1">≈ {(CONFIG.CLAIM_AMOUNT_SOL * CONFIG.TOKEN_SOL_VALUE).toFixed(2)} USD</p>
                        </div>
                        ...
                        <div className="p-4 rounded-xl bg-white/5 border border-white/5 relative overflow-hidden">
                          ...
                          <p className="text-green-400/70 text-xs mt-1">+{CONFIG.TOKEN_VALUE_USD / CONFIG.TOKEN_DIVIDER_VALUE} {CONFIG.TOKEN_SYMBOL}</p>
                        </div>
                      </div>
